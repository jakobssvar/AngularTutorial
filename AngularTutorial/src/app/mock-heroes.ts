...
export const HEROES: Hero[] = [
  { id: 0, name: 'Anne', description: 'the great one', lvl: 1, exp: 0, maxHp: 100, hp: 100, str: 5, def: 5, spd: 20, numberOfFights:0 },
  { id: 1, name: 'Ben', description: 'the old one', lvl: 1, exp: 0, maxHp: 120, hp: 120, str: 2, def: 2, spd: 6, numberOfFights: 0 },
  ...
  { id: 9, name: 'Jakob', description: 'the only one', lvl: 1, exp: 0, maxHp: 1000, hp: 1000, str: 50, def: 50, spd: 200, numberOfFights: 0 },
  { id: 10, name: 'Kaia', description: 'the second only one', lvl: 1, exp: 0, maxHp: 500, hp: 500, str: 45, def: 45, spd: 150, numberOfFights: 0 },
  { id: 11, name: 'Lars', description: 'the not-so-great one', lvl: 1, exp: 0, maxHp: 10, hp: 10, str: 1, def: 1, spd: 2, numberOfFights: 0  },
  { id: 12, name: 'Morten', description: 'not-the-Harket one', lvl: 1, exp: 0, maxHp: 20, hp: 20, str: 2, def: 2, spd: 5, numberOfFights: 0 }
